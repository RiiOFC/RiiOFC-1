...
╚══════╝   ╚═╝    ╚═════╝ ╚═╝     ╚═╝╚═════╝ ╚══════╝╚══════╝
    ...
    ██║  ██║╚██████╔╝███████║██║  ██║██║  ██╗                
    ╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝'                        
${chalk.blue('By :')} ${chalk.blue('RiiOFC')} ${chalk.blue('-')} ${chalk.blue('Script Dupe Trophy & Crown')}
${chalk.blue('Website : replit.com/@RiiOFC')}
${chalk.blue('Whaatshap : 081247822525')}
${chalk.blue('Discord : Rii.#7938')}
             
${chalk.green('Server Yang Digunakan :')} ${chalk.green('Server [1]')}
...
${chalk.red('Pilihlah Feature Sesuai Yang Kamu Dapatkan Pas Main Stumble Guys , Jika Tidak Sesuai Akan Kena Banned !')}
